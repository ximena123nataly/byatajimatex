...
function ExpenseAddNew() {
	...
	const insertExpense = async () => {
		...
		if (dueDate === "") {
			swal("¡Ups!", "Por favor selecciona una fecha de vencimiento", "error")
			return;
		}
						...
						: pageState === 2 ?
							<div className="card">
								<div className="container" style={{ display: "flex", flexDirection: "column" }}>
									<h4 style={{ marginLeft: "10px", marginTop: "5px", color: "darkseagreen", fontWeight: "bold" }}>Detalles básicos de gastos</h4>
									<div style={{ display: "flex", marginTop: "5px" }}>
										<div style={{ flexGrow: "1", textAlign: "center" }}>
											<input className='my_input' type='text' value={expenseRef} onChange={(e) => { setExpenseRef(e.target.value) }} placeholder='Referencia de gasto' />
										</div>
									...
									<h4 style={{ marginLeft: "10px", marginTop: "1rem", color: "darkseagreen", fontWeight: "bold" }}>Lista de gastos</h4>
