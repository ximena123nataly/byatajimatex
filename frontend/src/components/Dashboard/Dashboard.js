...
function Dashboard() {
  ...
  useEffect(() => {
    if (
      ...
      let t = data.map(x => ({
        ...x,
        percentage: total > 0 ? (x.count * 100) / total : 0
      }))
            ...
            : pageState === 2 ?
              <>
                ...
                <div className='second_panel'>
                  <div className='left'>
                    ...
                    <div className='itme_stats'>
                      <div style={{ flex: "1" }}>
                        ...
                        <div className='row'>
                          <div className='col-12 text-danger'>Artículos con stock bajo:</div>
                        </div>
...

                      {
                        ...
                        <div className='d-flex justify-content-center align-items-center' style={{ flex: "1", position: "relative" }}>
                          ...
                          <div style={{ fontSize: "smaller", position: "absolute" }}>
                            <div>
                              <div className='me-1' style={{ backgroundColor: "#516fc9", width: "10px", height: "10px", display: "inline-block", borderRadius: "3px" }}></div>
                              <span className='me-1'>Hombres:</span> <span>{productGenderP[1].count}</span>
                            </div>
                            <div>
                              <div className='me-1' style={{ backgroundColor: "#f07fce", width: "10px", height: "10px", display: "inline-block", borderRadius: "3px" }}></div>
                              <span className='me-1'>Mujeres:</span> <span>{productGenderP[0].count}</span>
                            </div>
                            <div>
                              <div className='me-1' style={{ backgroundColor: "#fcbc53", width: "10px", height: "10px", display: "inline-block", borderRadius: "3px" }}></div>
                              <span className='me-1'>Otros:</span> <span>{productGenderP[2].count}</span>
                            </div>
                          </div>
                        </div>
                      }
                  ...
                  <div className='right'>
                    <div className='title'>ARTÍCULOS MÁS VENDIDOS</div>
                    <hr className='my-1' style={{ color: "darkgrey" }} />
